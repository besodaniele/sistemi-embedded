...
Se un sottoinsieme di task viene gestito da un solo server, tutti i task di quel sottoinsieme condividono la stessa bandwidth, quindi non c'è isolazione tra loro.
...
\end{itemize}
Una proprietà interessante è quella dell'isolamento, ovvero, possiamo usare una strategia di preservamento della bandwidth per allocare una frazione del tempo di CPU per soft task per cui il
